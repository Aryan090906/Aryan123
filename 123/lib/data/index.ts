...
import { programmingLanguages, getProgrammingLanguageTopics, getProgrammingLanguageById } from './programming-languages';

// Combine all topics
export const topics = [...initialTopics, ...moreTopics, ...programmingLanguages];
